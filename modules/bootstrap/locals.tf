...
locals {
  ...
  parent          = var.root_node != "" ? var.root_node : var.organization_id
  ...
  sa_xpn_org_roles = (
    ...
    ? ["roles/compute.xpnAdmin", "roles/resourcemanager.organizationViewer", "roles/container.hostServiceAgentUser"]
