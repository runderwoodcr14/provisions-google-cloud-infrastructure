...
inputs = {
  ...
  subnetwork              = "europe-west1-subnet-07"
  ip_range_pods           = "europe-west1-subnet-07-secondary-pods"
  ip_range_services       = "europe-west1-subnet-07-secondary-svc"
  service_account         = dependency.service-project.outputs.service_accounts
  enable_private_endpoint = true
  enable_private_nodes    = true
  master_ipv4_cidr_block  = "10.0.0.48/28"
